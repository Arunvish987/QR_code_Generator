...
class Qr_Generator:
    def __init__(self, root):
        ...
        self.root.title("QR Generator | Developed by Arun")
        ...
        btn_clear = Button(emp_Frame,text='Clear',command=self.clear,font=("times new roman", 18,'bold'),bg='#607d8b',fg='white').place(x=285,y=250,width=120,height=30)
